...
const saveUserAstrologyResults = async (userInfo, chartData) => {
  try {
    ...
    const response = await fetch('http://backend-docker-production-c584.up.railway.app/api/astrology/save-results', {
      method: 'POST',
      headers: {
...
const fetchPlanetInterpretation = async (planet, zodiacSign) => {
  try {
    console.log(`Making API call: http://backend-docker-production-c584.up.railway.app/api/astrology/${planet}/${zodiacSign}`);
    
    const response = await fetch(`http://backend-docker-production-c584.up.railway.app/api/astrology/${planet}/${zodiacSign}`);
  ...
  useEffect(() => {
    const fetchUserProfile = async () => {
      try {
        ...
        const response = await fetch("http://backend-docker-production-c584.up.railway.app/api/auth/profile", {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
          },
