...
function NumerologyManagement() {
  ...
  useEffect(() => {
    const fetchSystems = async () => {
      try {
        const response = await fetch("https://backend-docker-production-c584.up.railway.app/api/numerology/system", {
          credentials: "include",
        });
  ...
  const handleAddSystem = async () => {
    try {
      const response = await fetch("https://backend-docker-production-c584.up.railway.app/api/Numerology", {
        method: "POST",
        headers: {
  ...
  const handleDeleteSystem = async () => {
    try {
      const response = await fetch(`https://backend-docker-production-c584.up.railway.app/api/Numerology/${selectedSystem.id}`, {
        method: "DELETE",
        credentials: "include",
      });
